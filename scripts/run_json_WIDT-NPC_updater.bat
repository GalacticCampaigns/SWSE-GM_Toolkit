...
py %PYTHON_SCRIPT_PATH% "D:\OneDrive\Documents\GitHub\SagaIndex\scripts\json\NPC_updates.json" --npc_profile_file "G:\My Drive\Google AI Studio\WIDT\WIDT_NPCS.json"
