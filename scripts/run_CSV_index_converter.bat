@echo off
REM Batch file to run the SAGA Multi CSV Index to JSON Python script
REM Created on: May 23, 2025

REM Script path - ensure this is correct
SET PYTHON_SCRIPT_PATH="D:\OneDrive\Documents\GitHub\SagaIndex\scripts\apps\saga_index_multi_converter.py"
